...
// +kubebuilder:webhook:path=/mutate-core-crd-fuxiansen-com-v1-application,mutating=true,failurePolicy=fail,sideEffects=None,groups=core.crd.fuxiansen.com,resources=applications,verbs=create;update,versions=v1,name=mapplication-v1.kb.io,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-core-crd-fuxiansen-com-v1-application,mutating=false,failurePolicy=fail,sideEffects=None,groups=core.crd.fuxiansen.com,resources=applications,verbs=create;update,versions=v1,name=vapplication-v1.kb.io,admissionReviewVersions=v1
